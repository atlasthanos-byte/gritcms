...
After running ` new gritcms`, you get:
...
- **Prometheus** — `/pulse/metrics` for Grafana
...
`ash
DATABASE_URL=postgres://postgres:password@localhost:5432/gritcms?sslmode=disable
PORT=8080
